-- SITE: https://sqlzoo.net/wiki/SELECT_from_Nobel_Tutorial
...
SELECT * FROM nobel
WHERE (yr = 1980 && subject = 'physics')
OR (yr = 1984 && subject = 'chemistry')
...
-- QUIZ: https://sqlzoo.net/wiki/Nobel_Quiz
